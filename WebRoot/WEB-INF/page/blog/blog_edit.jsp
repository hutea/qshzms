    ...
    <div class="mainwrapper">
        ...
        <div class="mainpanel">
             ...
             <div class="contentpanel">    
             	 <div class="content" >
             	 	 <form action="${pageContext.request.contextPath}/manage/blog/update" id="myform" name="myform" method="post"  > 
								    ...
								    <div class="col-md-3">
								    	...
								    	<select name="tid" class="form-control">
									    	<c:forEach items="${types}" var="type">
									      	<option value="${type.id }"  ${blog.blogType.id==type.id?'selected="selected"':'' } >${type.name }</option>
									    	</c:forEach>
									    </select>
								    </div>
								    <div class="col-md-2">
								  		...
								  		<select name="lv" class="form-control">
									    	<c:forEach begin="1" end="5" step="1" varStatus="s" > 
									      	<option value="${s.index }" ${blog.lv==s.index?'selected="selected"':'' } >${s.index}</option>
									    	</c:forEach>
									    </select>
								    </div>
								  </div>
		    					 <div class="form-group">
								    ...
								    <div class="col-md-2">
							            ...
							            <select name="recommend" class="form-control">
									      	<option value="true"  ${blog.recommend?'selected="selected"':''} >推荐【YES】</option>
									      	<option value="false" ${!blog.recommend?'selected="selected"':''} >推荐【NO】</option>
									    </select>
							        </div>
							        <div class="col-md-2">
								  		<label class="control-label" style="padding-top:4px" >浏览量</label>
								    	<input type="text" class="form-control" name="pv" value="${blog.pv}" >
								    </div>
							        <div class="col-md-2">
								  		<label class="control-label" style="padding-top:4px" >Like数</label>
								    	<input type="text" class="form-control" name="lk" value="${blog.lk}" >
								    </div>
								  </div>
								  
								  <div class="form-group">
								  	<div class="col-md-11">
									<textarea id="comteditor" class="ckeditor" name="content" style="height: 100px;border: 1px solid #d5d5d5;">${blog.content}</textarea>
									</div>
				                 </div>
				                 <div class="form-group">
