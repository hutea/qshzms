    ...
    <div class="mybody container">
        <div class="row">
            <div class="col-md-12">
		        ...
		        <div >
					<form class="form-horizontal" action="/my/star/save" method="post" enctype="multipart/form-data">
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-md-4">
					    	<div class='input-group date' >
					      		<input type="text" name="showDate" id='sdate'  class="form-control"  placeholder="演出时间">
