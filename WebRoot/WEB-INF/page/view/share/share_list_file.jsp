...
<div class="wrapall">
    ...
    <div class="hz-main"> 
    	...
    	<c:forEach items="${pageView.records}" var="entry" varStatus="s">  
                 ...
                 <div class="row hz-row-bottom">
                    ...
                    <div class="col-xs-4 col-sm-4 col-md-3 col-md-push-3 text-right">
	                    <div class="btn-group" role="group">
					        ...
					        <button class="btn btn-primary btn-sm dropdown-toggle" category="button" data-toggle="dropdown"><span class="caret"></span></button>
            ...
            <%@ include file="/WEB-INF/page/view/common/share_list_file_fenye.jsp" %>
