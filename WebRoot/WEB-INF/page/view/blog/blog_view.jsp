        ...
        <div class="row">
            ...
            <main class="col-md-8 main-content">
                <article id=85 class="post tag-about-ghost tag-release featured">
                    ...
                    <div class="post-head">
                        <h1 class="post-title"><a href="/blog/view/${blog.id}">${blog.title }</a></h1>
                        <div class="post-meta">
                            <span class="author">分类：<a href="/blog/${blog.blogType.code}/">${blog.blogType.name}</a></span> &bull;
                            <time class="post-date" title='<fmt:formatDate value="${blog.createDate}" pattern="yyyy年MM月dd日 HH时mm分ss秒"/>' >
                            	<fmt:formatDate value="${blog.createDate}" pattern="yyyy年MM月dd日"/>
                            </time>
                        </div>
                    </div>
                ...
                <nav class="prev-next-wrap clearfix" >
                	<c:if test="${lastBlog!=null}">
                    	<a class="btn btn-default" href="/blog/view/${lastBlog.id}"><i class="fa fa-angle-left fa-fw"></i> ${lastBlog.title}</a>
                	</c:if>
