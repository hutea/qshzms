...
<body>
             	 ...
             	 <div class="content" >
             	 	 <form action="${pageContext.request.contextPath}/manage/share/update" id="myform" name="myform" method="post"  > 
	    					...
	    					<div class="form-horizontal">
		    					 ...
		    					 <div class="form-group">
								    ...
								    <div class="col-md-2">
							            ...
							            <select name="recommend" class="form-control">
									      	<option value="true"  ${share.view?'selected="selected"':''} >直接可见</option>
									      	<option value="false" ${!share.view?'selected="selected"':''} >回复可见</option>
									    </select>
							        </div>
							        <div class="col-md-2">
								 ...
								 <div class="form-group">
								  	<div class="col-md-11">
									<textarea id="sumary-ckeditor" class="ckeditor" name="sumary" style="height: 100px;border: 1px solid #d5d5d5;">${share.sumary}</textarea>
									</div>
				                 </div>
								  <div class="form-group">
								  	<div class="col-md-11">
									<textarea id="content-ckeditor" class="ckeditor" name="content" style="height: 100px;border: 1px solid #d5d5d5;">${share.content}</textarea>
									</div>
				                 </div>
				                 <div class="form-group">
    ...
    var sumaryCkeditor = CKEDITOR.replace('sumary', {
    	toolbar:[   
