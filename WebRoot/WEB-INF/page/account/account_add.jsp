                ...
                <div class="mainpanel">
                    ...
                    <div class="contentpanel">
                    	<div class="content-xs" >
                         ...
                         <form action="/manage/account/save" method="post"  > 
	    					<div class="form-horizontal">
		    					 <div class="form-group">
								    <label  class="col-sm-2 control-label">用户名</label>
								    <div class="col-sm-4">
								      <input type="text" class="form-control" name="username"  onkeyup="checkUsername()" placeholder="用户名" id="username">
		    					 ...
		    					 <div class="form-group">
								    ...
								    <div class="col-sm-4">
								      <input type="text" class="form-control"  name="lv"  placeholder="用户类型(填写数字)">
								      <span></span>
								    </div>
